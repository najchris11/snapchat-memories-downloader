...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/snapchat_memories_downloader.composeapp.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/snapchat_memories_downloader.composeapp.generated.resources/" +
      path)
